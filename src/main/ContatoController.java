...
import com.exemplo.agenda.ContatoView;
...
public class ContatoController {
     ...
     *
     * @param view  A interface gráfica com a qual o usuário vai interagir.
    ...
    private void inicializarAcoes() {
        ...
        view.getBtnAtualizar().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int id = Integer.parseInt(view.getTabelaContatos().getValueAt(selectedRow, 0).toString());
                String nome = view.getTxtNome().getText();
                String telefone = view.getTxtTelefone().getText();
        ...
        view.getBtnListar().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                view.getTabelaContatos().setRowCount(0); // Limpa a tabela
                for (Contato contato : contatos) {
                    view.getTabelaContatos().addRow(new Object[]{contato.getId(), contato.getNome(), contato.getTelefone()});
                }
            }
        });
    }
